  ...
  return (
    <>
      <main className="border-b border-main py-[2vh]">
        <ul className="flex justify-between text-[0.8vw]">
          ...
          <div className="flex-1 text-center">
            <button className="font-pretendard font-medium text-[0.8vw] min-w-[2vw] min-h-[2vh] rounded-md text-white bg-main">
              수정
            </button>
          </div>
          <div className="flex-1 text-center">
            <button className="font-pretendard font-medium text-[0.8vw] min-w-[2vw] min-h-[2vh] rounded-md text-white bg-red">
              삭제
            </button>
          </div>
        </ul>
